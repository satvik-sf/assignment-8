$(document).ready(function(){
    ...
    var edit = function() {
        ...
        let save_btn = document.getElementById( "save_button_" + attribute);
        console.log(save_btn);
        save_btn!.style.display = 'inline-block';

        let cancel_btn = document.getElementById( "cancel_button_" + attribute);
    ...
    let edit_btns = document.getElementsByClassName("edit_button");
    ...
    let save_btns = document.getElementsByClassName("save_button");
